...
mixin _$AdminUserSummary {
 ...
 String get id; String get email; String get displayName; String get role; String get userTypeId; double get balance;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminUserSummary&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.role, role) || other.role == role)&&(identical(other.userTypeId, userTypeId) || other.userTypeId == userTypeId)&&(identical(other.balance, balance) || other.balance == balance));
}


@override
int get hashCode => Object.hash(runtimeType,id,email,displayName,role,userTypeId,balance);

@override
String toString() {
  return 'AdminUserSummary(id: $id, email: $email, displayName: $displayName, role: $role, userTypeId: $userTypeId, balance: $balance)';
}
...
@useResult
$Res call({
 String id, String email, String displayName, String role, String userTypeId, double balance
});
...
/// Create a copy of AdminUserSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? displayName = null,Object? role = null,Object? userTypeId = null,Object? balance = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,role: null == role ? _self.role : role // ignore: cast_nullable_to_non_nullable
as String,userTypeId: null == userTypeId ? _self.userTypeId : userTypeId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String displayName,  String role,  String userTypeId,  double balance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminUserSummary() when $default != null:
return $default(_that.id,_that.email,_that.displayName,_that.role,_that.userTypeId,_that.balance);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String displayName,  String role,  String userTypeId,  double balance)  $default,) {final _that = this;
switch (_that) {
case _AdminUserSummary():
return $default(_that.id,_that.email,_that.displayName,_that.role,_that.userTypeId,_that.balance);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String displayName,  String role,  String userTypeId,  double balance)?  $default,) {final _that = this;
switch (_that) {
case _AdminUserSummary() when $default != null:
return $default(_that.id,_that.email,_that.displayName,_that.role,_that.userTypeId,_that.balance);case _:
  return null;
...
class _AdminUserSummary implements AdminUserSummary {
  const _AdminUserSummary({required this.id, required this.email, required this.displayName, required this.role, required this.userTypeId, this.balance = 0.0});
...
@override final  String userTypeId;
...
/// Create a copy of AdminUserSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? displayName = null,Object? role = null,Object? userTypeId = null,Object? balance = null,}) {
